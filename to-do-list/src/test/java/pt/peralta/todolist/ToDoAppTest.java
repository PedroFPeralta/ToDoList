...
import static pt.peralta.todolist.TestConstants.TODO;
import static pt.peralta.todolist.TestConstants.TODOS;
...
public class ToDoAppTest {
	...
	public void testUpdateTodoFailure() {
		...
		webTestClient
				...
				.bodyValue(
						new Todo(unexinstingId, "Dale", "Riks", false, 0))
				.exchange()
    ...
    @Sql("/import.sql")
    @Test
	public void testUpdateTodoBadRequestFailure() {

		webTestClient
				.put()
				.uri("/todos/" + TODO.getId())
				.bodyValue(
						new Todo( TODO.getId(), "", "", false, 0))
				.exchange()
				.expectStatus().isBadRequest();
	}
